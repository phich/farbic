    ...
    <div>
      <div class="flex-view">
        <InputGroup>
          ...
          <InputText v-model="baseAttr.value" @change="changeCommon" />
        </InputGroup>
        <!-- <div class="flex-item">
      ...
      <div class="flex-view" v-if="baseAttr.displayValue">
        <InputGroup>
          <InputGroupAddon>Character</InputGroupAddon>
          <InputText v-model="baseAttr.text" @change="changeCommon" />
        </InputGroup>
        <!-- <div class="flex-item">
          <span class="label">文字</span>
          <div class="content">
            <Input v-model="baseAttr.text" @change="changeCommon" />
          </div>
        </div> -->
      </div>
      ...
      <div class="flex-view">
        ...
        <div class="flex-item" v-if="baseAttr.displayValue">
          ...
          <div class="content">
            <Select
              v-model="baseAttr.textPosition"
              @change="changeCommon"
              :options="textPositionOption"
              option-label="label"
              option-value="value"
            >
      ...
      <div class="flex-view">
        ...
        <div class="flex-item">
          <span class="label" style="margin-left: 10px">Format</span>
          <div class="content">
            <Select
