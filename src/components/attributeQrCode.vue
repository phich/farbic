...
<template>
  ...
  >
    ...
    <div>
      <div class="flex-view">
        <InputGroup>
          <InputGroupAddon><span class="label">Content</span> </InputGroupAddon>
          <InputText v-model="baseAttr.data" @change="changeCommon" />
        </InputGroup>
        <!-- <div class="flex-item">
          <div class="content">
            <InputText v-model="baseAttr.data" @change="changeCommon" />
        ...
        <div class="flex-item">
          ...
          <div class="content">
            <Select
              ...
              @change="changeCommon"
              style="width: 90px"
              :options="optionsList.cornersDotType"
            >
              <!-- <Option
        ...
        <div class="flex-item">
          ...
          <div class="content">
            <Select
              ...
              @change="changeCommon"
              style="width: 90px"
              :options="optionsList.errorCorrectionLevelType"
            >
              <!-- <Option
