...
<template>
  <div class="home">
    <Fluid>
      <div class="card">
        <div v-if="state.show" class="flex flex-row w-4/5 inline-block">
          <!-- 导入 -->
        ...
        <div style="display: flex; height: calc(100vh - 64px)">
          ...
          >
            <!-- 左侧菜单 -->
            <Menu :model="leftBar" style="min-width: 6.5rem">
          ...
          <div class="right-bar" v-show="state.attrBarShow">
            <div v-if="state.show" style="padding-top: 10px">
              ...
              >
                ...
                <!-- 新增字体样式使用 -->
                <Button
                  @click="canvasEditor.getFontJson()"
                  size="small"
                  class="mt-3"
                  >获取元素数据</Button
                >
...
const leftBar = ref([
  ...
  },
  {
    ...
    command: () => {
      showToolsBar("fontStyle");
    },
  },
  {
    // 图片元素

    label: t("material.cartoon"),
    icon: "ios-leaf-outline",
    command: () => {
      showToolsBar("material");
    },
  },
  {
    // 图层
