...
<template>
  ...
  >
    <Divider plain orientation="left">
      <h4>Picture filters</h4>
    </Divider>
    <Accordion>
      <AccordionPanel value="0">
        <AccordionHeader>{{ $t("filters.simple") }}</AccordionHeader>
        <AccordionContent
      ...
      <AccordionPanel value="1">
        <AccordionHeader> {{ $t("filters.complex") }}</AccordionHeader>
        <AccordionContent
          ><div>
            <div
            ...
            >
              ...
              <div v-if="item.status" class="content">
                <div
                  ...
                  :key="info"
                >
                  <div v-if="info.uiType === uiType.SELECT" class="mt-3">
                    <div
                  ...
                  <div v-if="info.uiType === uiType.NUMBER" class="mt-3">
                    <Slider
                      v-model="info.value"
                      :max="info.max"
                      :min="info.min"
                  ...
                  <div v-if="info.uiType === uiType.COLOR" class="mt-3">
                    <ColorPicker
                      v-model="info.value"
                      alpha
                      size="small"
